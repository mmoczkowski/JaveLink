...
public class MavLink {
	 ...
	 */
	public static class MAV_MSG_OMNIDIRECTIONAL_FLOW extends Message {
		...
		public MAV_MSG_OMNIDIRECTIONAL_FLOW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_OMNIDIRECTIONAL_FLOW (short systemId, short componentId, long time_usec  , float front_distance_m  , int left [] , int right [] , int sensor_id  , int quality  ) {
	 ...
	 */
	public static class MAV_MSG_HIL_SENSOR extends Message {
		...
		public MAV_MSG_HIL_SENSOR (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_SENSOR (short systemId, short componentId, long time_usec  , float xacc  , float yacc  , float zacc  , float xgyro  , float ygyro  , float zgyro  , float xmag  , float ymag  , float zmag  , float abs_pressure  , float diff_pressure  , float pressure_alt  , float temperature  , long fields_updated  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.xacc = xacc;
			this.yacc = yacc;
	 ...
	 */
	public static class MAV_MSG_GPS_RTK extends Message {
		...
		public MAV_MSG_GPS_RTK (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS_RTK (short systemId, short componentId, long time_last_baseline_ms  , long tow  , int baseline_a_mm  , int baseline_b_mm  , int baseline_c_mm  , long accuracy  , int iar_num_hypotheses  , int wn  , int rtk_receiver_id  , int rtk_health  , int rtk_rate  , int nsats  , int baseline_coords_type  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_SERVO_OUTPUT_RAW extends Message {
		...
		public MAV_MSG_SERVO_OUTPUT_RAW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SERVO_OUTPUT_RAW (short systemId, short componentId, long time_usec  , int servo1_raw  , int servo2_raw  , int servo3_raw  , int servo4_raw  , int servo5_raw  , int servo6_raw  , int servo7_raw  , int servo8_raw  , int port  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	 ...
	 */
	public static class MAV_MSG_GLOBAL_POSITION_INT extends Message {
		...
		public MAV_MSG_GLOBAL_POSITION_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GLOBAL_POSITION_INT (short systemId, short componentId, long time_boot_ms  , int lat  , int lon  , int alt  , int relative_alt  , int vx  , int vy  , int vz  , int hdg  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_LOG_ENTRY extends Message {
		...
		public MAV_MSG_LOG_ENTRY (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOG_ENTRY (short systemId, short componentId, long time_utc  , long size  , int id  , int num_logs  , int last_log_num  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_NAMED_VALUE_INT extends Message {
	
		private long time_boot_ms; // Timestamp (milliseconds since system boot)
		private int value; // Signed integer value
		private char name[] = new char[10]; // Name of the debug variable
	
		public MAV_MSG_NAMED_VALUE_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_NAMED_VALUE_INT (short systemId, short componentId, long time_boot_ms  , int value  , char name [] ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.value = value;
			this.name = name;
	 ...
	 */
	public static class MAV_MSG_MEMORY_VECT extends Message {
		...
		public MAV_MSG_MEMORY_VECT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MEMORY_VECT (short systemId, short componentId, int address  , int ver  , int type  , int value [] ) {
			super(systemId, componentId);
	 ...
	 * Erase all logs
	 */
	public static class MAV_MSG_LOG_ERASE extends Message {
	
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_LOG_ERASE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOG_ERASE (short systemId, short componentId, int target_system  , int target_component  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_RAW_PRESSURE extends Message {
		...
		public MAV_MSG_RAW_PRESSURE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_RAW_PRESSURE (short systemId, short componentId, long time_usec  , int press_abs  , int press_diff1  , int press_diff2  , int temperature  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	 ...
	 */
	public static class MAV_MSG_GPS_INJECT_DATA extends Message {
		...
		public MAV_MSG_GPS_INJECT_DATA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS_INJECT_DATA (short systemId, short componentId, int target_system  , int target_component  , int len  , int data [] ) {
			super(systemId, componentId);
			this.target_system = target_system;
			this.target_component = target_component;
			this.len = len;
	 ...
	 */
	public static class MAV_MSG_LOG_REQUEST_END extends Message {
	
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_LOG_REQUEST_END (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOG_REQUEST_END (short systemId, short componentId, int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.target_system = target_system;
			this.target_component = target_component;
		}
	 ...
	 */
	public static class MAV_MSG_LOCAL_POSITION_NED extends Message {
		...
		public MAV_MSG_LOCAL_POSITION_NED (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOCAL_POSITION_NED (short systemId, short componentId, long time_boot_ms  , float x  , float y  , float z  , float vx  , float vy  , float vz  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_MISSION_ACK extends Message {
	
		private int target_system; // System ID
		private int target_component; // Component ID
		private int type; // See MAV_MISSION_RESULT enum
	
		public MAV_MSG_MISSION_ACK (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_ACK (short systemId, short componentId, int target_system  , int target_component  , int type  ) {
			super(systemId, componentId);
			this.target_system = target_system;
			this.target_component = target_component;
			this.type = type;
	 ...
	 */
	public static class MAV_MSG_HIL_CONTROLS extends Message {
		...
		public MAV_MSG_HIL_CONTROLS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_CONTROLS (short systemId, short componentId, long time_usec  , float roll_ailerons  , float pitch_elevator  , float yaw_rudder  , float throttle  , float aux1  , float aux2  , float aux3  , float aux4  , int mode  , int nav_mode  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	 ...
	 */
	public static class MAV_MSG_MISSION_ITEM_INT extends Message {
		...
		public MAV_MSG_MISSION_ITEM_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_ITEM_INT (short systemId, short componentId, float param1  , float param2  , float param3  , float param4  , int x  , int y  , float z  , int seq  , int command  , int target_system  , int target_component  , int frame  , int current  , int autocontinue  ) {
			super(systemId, componentId);
			this.param1 = param1;
			this.param2 = param2;
			this.param3 = param3;
	...
	public static class MAV_MSG_DISTANCE_SENSOR extends Message {
		...
		public MAV_MSG_DISTANCE_SENSOR (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_DISTANCE_SENSOR (short systemId, short componentId, long time_boot_ms  , int min_distance  , int max_distance  , int current_distance  , int type  , int id  , int orientation  , int covariance  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
	 ...
	 */
	public static class MAV_MSG_SIM_STATE extends Message {
		...
		public MAV_MSG_SIM_STATE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SIM_STATE (short systemId, short componentId, float q1  , float q2  , float q3  , float q4  , float roll  , float pitch  , float yaw  , float xacc  , float yacc  , float zacc  , float xgyro  , float ygyro  , float zgyro  , float lat  , float lon  , float alt  , float std_dev_horz  , float std_dev_vert  , float vn  , float ve  , float vd  ) {
			super(systemId, componentId);
			this.q1 = q1;
			this.q2 = q2;
			this.q3 = q3;
	 ...
	 */
	public static class MAV_MSG_AUTOPILOT_VERSION extends Message {
		...
		public MAV_MSG_AUTOPILOT_VERSION (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_AUTOPILOT_VERSION (short systemId, short componentId, long capabilities  , long version  , int custom_version [] ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_SET_MODE extends Message {
		...
		public MAV_MSG_SET_MODE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SET_MODE (short systemId, short componentId, long custom_mode  , int target_system  , int base_mode  ) {
			super(systemId, componentId);
	...
	public static class MAV_MSG_GLOBAL_VISION_POSITION_ESTIMATE extends Message {
		...
		public MAV_MSG_GLOBAL_VISION_POSITION_ESTIMATE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GLOBAL_VISION_POSITION_ESTIMATE (short systemId, short componentId, long usec  , float x  , float y  , float z  , float roll  , float pitch  , float yaw  ) {
			super(systemId, componentId);
			this.usec = usec;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_SCALED_IMU extends Message {
		...
		public MAV_MSG_SCALED_IMU (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SCALED_IMU (short systemId, short componentId, long time_boot_ms  , int xacc  , int yacc  , int zacc  , int xgyro  , int ygyro  , int zgyro  , int xmag  , int ymag  , int zmag  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.xacc = xacc;
			this.yacc = yacc;
	 ...
	 */
	public static class MAV_MSG_SERIAL_CONTROL extends Message {
		...
		public MAV_MSG_SERIAL_CONTROL (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SERIAL_CONTROL (short systemId, short componentId, long baudrate  , int timeout  , int device  , int flags  , int count  , int data [] ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_SAFETY_SET_ALLOWED_AREA extends Message {
		...
		public MAV_MSG_SAFETY_SET_ALLOWED_AREA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SAFETY_SET_ALLOWED_AREA (short systemId, short componentId, float p1x  , float p1y  , float p1z  , float p2x  , float p2y  , float p2z  , int target_system  , int target_component  , int frame  ) {
			super(systemId, componentId);
			this.p1x = p1x;
			this.p1y = p1y;
			this.p1z = p1z;
	...
	public static class MAV_MSG_VICON_POSITION_ESTIMATE extends Message {
		...
		public MAV_MSG_VICON_POSITION_ESTIMATE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_VICON_POSITION_ESTIMATE (short systemId, short componentId, long usec  , float x  , float y  , float z  , float roll  , float pitch  , float yaw  ) {
			super(systemId, componentId);
			this.usec = usec;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_NAMED_VALUE_FLOAT extends Message {
	
		private long time_boot_ms; // Timestamp (milliseconds since system boot)
		private float value; // Floating point value
		private char name[] = new char[10]; // Name of the debug variable
	
		public MAV_MSG_NAMED_VALUE_FLOAT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_NAMED_VALUE_FLOAT (short systemId, short componentId, long time_boot_ms  , float value  , char name [] ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.value = value;
			this.name = name;
	 ...
	 */
	public static class MAV_MSG_TERRAIN_REPORT extends Message {
		...
		public MAV_MSG_TERRAIN_REPORT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_TERRAIN_REPORT (short systemId, short componentId, int lat  , int lon  , float terrain_height  , float current_height  , int spacing  , int pending  , int loaded  ) {
			super(systemId, componentId);
			this.lat = lat;
			this.lon = lon;
	 ...
	 */
	public static class MAV_MSG_COMMAND_LONG extends Message {
		...
		public MAV_MSG_COMMAND_LONG (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_COMMAND_LONG (short systemId, short componentId, float param1  , float param2  , float param3  , float param4  , float param5  , float param6  , float param7  , int command  , int target_system  , int target_component  , int confirmation  ) {
			super(systemId, componentId);
			this.param1 = param1;
			this.param2 = param2;
			this.param3 = param3;
	 ...
	 */
	public static class MAV_MSG_RAW_IMU extends Message {
		...
		public MAV_MSG_RAW_IMU (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_RAW_IMU (short systemId, short componentId, long time_usec  , int xacc  , int yacc  , int zacc  , int xgyro  , int ygyro  , int zgyro  , int xmag  , int ymag  , int zmag  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.xacc = xacc;
			this.yacc = yacc;
	 ...
	 */
	public static class MAV_MSG_LOG_REQUEST_DATA extends Message {
		...
		public MAV_MSG_LOG_REQUEST_DATA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOG_REQUEST_DATA (short systemId, short componentId, long ofs  , long count  , int id  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.ofs = ofs;
			this.count = count;
			this.id = id;
	 ...
	 */
	public static class MAV_MSG_DEBUG extends Message {
	
		private long time_boot_ms; // Timestamp (milliseconds since system boot)
		private float value; // DEBUG value
		private int ind; // index of debug variable
	
		public MAV_MSG_DEBUG (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_DEBUG (short systemId, short componentId, long time_boot_ms  , float value  , int ind  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.value = value;
			this.ind = ind;
	 ...
	 */
	public static class MAV_MSG_PARAM_SET extends Message {
		...
		public MAV_MSG_PARAM_SET (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_PARAM_SET (short systemId, short componentId, float param_value  , int target_system  , int target_component  , char param_id [] , int param_type  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_V2_EXTENSION extends Message {
		...
		public MAV_MSG_V2_EXTENSION (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_V2_EXTENSION (short systemId, short componentId, int message_type  , int target_network  , int target_system  , int target_component  , int payload [] ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_ATTITUDE extends Message {
		...
		public MAV_MSG_ATTITUDE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_ATTITUDE (short systemId, short componentId, long time_boot_ms  , float roll  , float pitch  , float yaw  , float rollspeed  , float pitchspeed  , float yawspeed  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.roll = roll;
			this.pitch = pitch;
	 ...
	 */
	public static class MAV_MSG_ATTITUDE_QUATERNION extends Message {
		...
		public MAV_MSG_ATTITUDE_QUATERNION (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_ATTITUDE_QUATERNION (short systemId, short componentId, long time_boot_ms  , float q1  , float q2  , float q3  , float q4  , float rollspeed  , float pitchspeed  , float yawspeed  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.q1 = q1;
			this.q2 = q2;
	...
	public static class MAV_MSG_DATA_TRANSMISSION_HANDSHAKE extends Message {
		...
		public MAV_MSG_DATA_TRANSMISSION_HANDSHAKE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_DATA_TRANSMISSION_HANDSHAKE (short systemId, short componentId, long size  , int width  , int height  , int packets  , int type  , int payload  , int jpg_quality  ) {
			super(systemId, componentId);
			this.size = size;
			this.width = width;
			this.height = height;
	 ...
	 */
	public static class MAV_MSG_LOG_REQUEST_LIST extends Message {
		...
		public MAV_MSG_LOG_REQUEST_LIST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOG_REQUEST_LIST (short systemId, short componentId, int start  , int end  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.start = start;
			this.end = end;
			this.target_system = target_system;
	...
	public static class MAV_MSG_DEBUG_VECT extends Message {
		...
		public MAV_MSG_DEBUG_VECT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_DEBUG_VECT (short systemId, short componentId, long time_usec  , float x  , float y  , float z  , char name [] ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_OPTICAL_FLOW extends Message {
		...
		public MAV_MSG_OPTICAL_FLOW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_OPTICAL_FLOW (short systemId, short componentId, long time_usec  , float flow_comp_m_x  , float flow_comp_m_y  , float ground_distance  , int flow_x  , int flow_y  , int sensor_id  , int quality  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	 ...
	 */
	public static class MAV_MSG_MISSION_ITEM_REACHED extends Message {
	
		private int seq; // Sequence
	
		public MAV_MSG_MISSION_ITEM_REACHED (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_ITEM_REACHED (short systemId, short componentId, int seq  ) {
			super(systemId, componentId);
			this.seq = seq;
		}
	 ...
	 */
	public static class MAV_MSG_MISSION_REQUEST_PARTIAL_LIST extends Message {
		...
		public MAV_MSG_MISSION_REQUEST_PARTIAL_LIST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_REQUEST_PARTIAL_LIST (short systemId, short componentId, int start_index  , int end_index  , int target_system  , int target_component  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_PARAM_REQUEST_LIST extends Message {
	
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_PARAM_REQUEST_LIST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_PARAM_REQUEST_LIST (short systemId, short componentId, int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.target_system = target_system;
			this.target_component = target_component;
		}
	 ...
	 * The filtered local position (e.g. fused computer vision and accelerometers). Coordinate frame is right-handed, Z-axis down (aeronautical frame, NED / north-east-down convention)
	 */
	public static class MAV_MSG_LOCAL_POSITION_NED_COV extends Message {
		...
		public MAV_MSG_LOCAL_POSITION_NED_COV (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOCAL_POSITION_NED_COV (short systemId, short componentId, long time_utc  , long time_boot_ms  , float x  , float y  , float z  , float vx  , float vy  , float vz  , float covariance [] , int estimator_type  ) {
			super(systemId, componentId);
			this.time_utc = time_utc;
			this.time_boot_ms = time_boot_ms;
			this.x = x;
	 ...
	 */
	public static class MAV_MSG_COMMAND_ACK extends Message {
	
		private int command; // Command ID, as defined by MAV_CMD enum.
		private int result; // See MAV_RESULT enum
	
		public MAV_MSG_COMMAND_ACK (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_COMMAND_ACK (short systemId, short componentId, int command  , int result  ) {
			super(systemId, componentId);
			this.command = command;
			this.result = result;
		}
	 ...
	 */
	public static class MAV_MSG_SCALED_IMU2 extends Message {
		...
		public MAV_MSG_SCALED_IMU2 (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SCALED_IMU2 (short systemId, short componentId, long time_boot_ms  , int xacc  , int yacc  , int zacc  , int xgyro  , int ygyro  , int zgyro  , int xmag  , int ymag  , int zmag  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.xacc = xacc;
			this.yacc = yacc;
	 ...
	 */
	public static class MAV_MSG_POSITION_TARGET_LOCAL_NED extends Message {
		...
		public MAV_MSG_POSITION_TARGET_LOCAL_NED (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_POSITION_TARGET_LOCAL_NED (short systemId, short componentId, long time_boot_ms  , float x  , float y  , float z  , float vx  , float vy  , float vz  , float afx  , float afy  , float afz  , float yaw  , float yaw_rate  , int type_mask  , int coordinate_frame  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_TERRAIN_DATA extends Message {
		...
		public MAV_MSG_TERRAIN_DATA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_TERRAIN_DATA (short systemId, short componentId, int lat  , int lon  , int grid_spacing  , int data [] , int gridbit  ) {
			super(systemId, componentId);
			this.lat = lat;
			this.lon = lon;
	 ...
	 */
	public static class MAV_MSG_AUTH_KEY extends Message {
	
		private char key[] = new char[32]; // key
	
		public MAV_MSG_AUTH_KEY (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_AUTH_KEY (short systemId, short componentId, char key [] ) {
			super(systemId, componentId);
			this.key = key;
		}
	 ...
	 */
	public static class MAV_MSG_GPS_GLOBAL_ORIGIN extends Message {
		...
		public MAV_MSG_GPS_GLOBAL_ORIGIN (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS_GLOBAL_ORIGIN (short systemId, short componentId, int latitude  , int longitude  , int altitude  ) {
			super(systemId, componentId);
	...
	public static class MAV_MSG_REQUEST_DATA_STREAM extends Message {
		...
		public MAV_MSG_REQUEST_DATA_STREAM (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_REQUEST_DATA_STREAM (short systemId, short componentId, int req_message_rate  , int target_system  , int target_component  , int req_stream_id  , int start_stop  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_MISSION_ITEM extends Message {
		...
		public MAV_MSG_MISSION_ITEM (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_ITEM (short systemId, short componentId, float param1  , float param2  , float param3  , float param4  , float x  , float y  , float z  , int seq  , int command  , int target_system  , int target_component  , int frame  , int current  , int autocontinue  ) {
			super(systemId, componentId);
			this.param1 = param1;
			this.param2 = param2;
			this.param3 = param3;
	 ...
	 */
	public static class MAV_MSG_MANUAL_SETPOINT extends Message {
		...
		public MAV_MSG_MANUAL_SETPOINT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MANUAL_SETPOINT (short systemId, short componentId, long time_boot_ms  , float roll  , float pitch  , float yaw  , float thrust  , int mode_switch  , int manual_override_switch  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.roll = roll;
			this.pitch = pitch;
	 ...
	 */
	public static class MAV_MSG_HEARTBEAT extends Message {
		...
		public MAV_MSG_HEARTBEAT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HEARTBEAT (short systemId, short componentId, long custom_mode  , int type  , int autopilot  , int base_mode  , int system_status  , int mavlink_version  ) {
			super(systemId, componentId);
			this.custom_mode = custom_mode;
			this.type = type;
	 ...
	 */
	public static class MAV_MSG_PING extends Message {
		...
		public MAV_MSG_PING (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_PING (short systemId, short componentId, long time_usec  , long seq  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.seq = seq;
			this.target_system = target_system;
	 ...
	 */
	public static class MAV_MSG_SYSTEM_TIME extends Message {
		...
		public MAV_MSG_SYSTEM_TIME (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SYSTEM_TIME (short systemId, short componentId, long time_unix_usec  , long time_boot_ms  ) {
			super(systemId, componentId);
	...
	public static class MAV_MSG_ENCAPSULATED_DATA extends Message {
	
		private int seqnr; // sequence number (starting with 0 on every transmission)
		private int data[] = new int[253]; // image data bytes
	
		public MAV_MSG_ENCAPSULATED_DATA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_ENCAPSULATED_DATA (short systemId, short componentId, int seqnr  , int data [] ) {
			super(systemId, componentId);
			this.seqnr = seqnr;
			this.data = data;
		}
	 ...
	 * The attitude in the aeronautical frame (right-handed, Z-down, X-front, Y-right), expressed as quaternion. Quaternion order is w, x, y, z and a zero rotation would be expressed as (1 0 0 0).
	 */
	public static class MAV_MSG_ATTITUDE_QUATERNION_COV extends Message {
		...
		public MAV_MSG_ATTITUDE_QUATERNION_COV (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_ATTITUDE_QUATERNION_COV (short systemId, short componentId, long time_boot_ms  , float q [] , float rollspeed  , float pitchspeed  , float yawspeed  , float covariance [] ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.q = q;
			this.rollspeed = rollspeed;
	 ...
	 */
	public static class MAV_MSG_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET extends Message {
		...
		public MAV_MSG_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET (short systemId, short componentId, long time_boot_ms  , float x  , float y  , float z  , float roll  , float pitch  , float yaw  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.x = x;
			this.y = y;
	 ...
	 * RTK GPS data. Gives information on the relative baseline calculation the GPS is reporting
	 */
	public static class MAV_MSG_GPS2_RTK extends Message {
		...
		public MAV_MSG_GPS2_RTK (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS2_RTK (short systemId, short componentId, long time_last_baseline_ms  , long tow  , int baseline_a_mm  , int baseline_b_mm  , int baseline_c_mm  , long accuracy  , int iar_num_hypotheses  , int wn  , int rtk_receiver_id  , int rtk_health  , int rtk_rate  , int nsats  , int baseline_coords_type  ) {
			super(systemId, componentId);
			this.time_last_baseline_ms = time_last_baseline_ms;
			this.tow = tow;
			this.baseline_a_mm = baseline_a_mm;
	...
	public static class MAV_MSG_VISION_SPEED_ESTIMATE extends Message {
		...
		public MAV_MSG_VISION_SPEED_ESTIMATE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_VISION_SPEED_ESTIMATE (short systemId, short componentId, long usec  , float x  , float y  , float z  ) {
			super(systemId, componentId);
			this.usec = usec;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_FILE_TRANSFER_PROTOCOL extends Message {
		...
		public MAV_MSG_FILE_TRANSFER_PROTOCOL (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_FILE_TRANSFER_PROTOCOL (short systemId, short componentId, int target_network  , int target_system  , int target_component  , int payload [] ) {
			super(systemId, componentId);
			this.target_network = target_network;
			this.target_system = target_system;
			this.target_component = target_component;
	 ...
	 */
	public static class MAV_MSG_CHANGE_OPERATOR_CONTROL extends Message {
		...
		public MAV_MSG_CHANGE_OPERATOR_CONTROL (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_CHANGE_OPERATOR_CONTROL (short systemId, short componentId, int target_system  , int control_request  , int version  , char passkey [] ) {
			super(systemId, componentId);
			this.target_system = target_system;
	 ...
	 */
	public static class MAV_MSG_GPS_RAW_INT extends Message {
		...
		public MAV_MSG_GPS_RAW_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS_RAW_INT (short systemId, short componentId, long time_usec  , int lat  , int lon  , int alt  , int eph  , int epv  , int vel  , int cog  , int fix_type  , int satellites_visible  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.lat = lat;
			this.lon = lon;
	 ...
	 */
	public static class MAV_MSG_RADIO_STATUS extends Message {
		...
		public MAV_MSG_RADIO_STATUS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_RADIO_STATUS (short systemId, short componentId, int rxerrors  , int fixed  , int rssi  , int remrssi  , int txbuf  , int noise  , int remnoise  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_CHANGE_OPERATOR_CONTROL_ACK extends Message {
		...
		public MAV_MSG_CHANGE_OPERATOR_CONTROL_ACK (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_CHANGE_OPERATOR_CONTROL_ACK (short systemId, short componentId, int gcs_system_id  , int control_request  , int ack  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_SET_ATTITUDE_TARGET extends Message {
		...
		public MAV_MSG_SET_ATTITUDE_TARGET (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SET_ATTITUDE_TARGET (short systemId, short componentId, long time_boot_ms  , float q [] , float body_roll_rate  , float body_pitch_rate  , float body_yaw_rate  , float thrust  , int target_system  , int target_component  , int type_mask  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.q = q;
	 ...
	 */
	public static class MAV_MSG_RC_CHANNELS_RAW extends Message {
		...
		public MAV_MSG_RC_CHANNELS_RAW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_RC_CHANNELS_RAW (short systemId, short componentId, long time_boot_ms  , int chan1_raw  , int chan2_raw  , int chan3_raw  , int chan4_raw  , int chan5_raw  , int chan6_raw  , int chan7_raw  , int chan8_raw  , int port  , int rssi  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
	 ...
	 */
	public static class MAV_MSG_STATUSTEXT extends Message {
		...
		public MAV_MSG_STATUSTEXT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_STATUSTEXT (short systemId, short componentId, int severity  , char text [] ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_GLOBAL_POSITION_INT_COV extends Message {
		...
		public MAV_MSG_GLOBAL_POSITION_INT_COV (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GLOBAL_POSITION_INT_COV (short systemId, short componentId, long time_utc  , long time_boot_ms  , int lat  , int lon  , int alt  , int relative_alt  , float vx  , float vy  , float vz  , float covariance [] , int estimator_type  ) {
			super(systemId, componentId);
			this.time_utc = time_utc;
			this.time_boot_ms = time_boot_ms;
			this.lat = lat;
	...
	public static class MAV_MSG_VISION_POSITION_ESTIMATE extends Message {
		...
		public MAV_MSG_VISION_POSITION_ESTIMATE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_VISION_POSITION_ESTIMATE (short systemId, short componentId, long usec  , float x  , float y  , float z  , float roll  , float pitch  , float yaw  ) {
			super(systemId, componentId);
			this.usec = usec;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_HIL_STATE extends Message {
		...
		public MAV_MSG_HIL_STATE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_STATE (short systemId, short componentId, long time_usec  , float roll  , float pitch  , float yaw  , float rollspeed  , float pitchspeed  , float yawspeed  , int lat  , int lon  , int alt  , int vx  , int vy  , int vz  , int xacc  , int yacc  , int zacc  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.roll = roll;
			this.pitch = pitch;
	 ...
	 */
	public static class MAV_MSG_LOG_DATA extends Message {
		...
		public MAV_MSG_LOG_DATA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_LOG_DATA (short systemId, short componentId, long ofs  , int id  , int count  , int data [] ) {
			super(systemId, componentId);
			this.ofs = ofs;
			this.id = id;
			this.count = count;
	 ...
	 */
	public static class MAV_MSG_MISSION_REQUEST_LIST extends Message {
	
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_MISSION_REQUEST_LIST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_REQUEST_LIST (short systemId, short componentId, int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.target_system = target_system;
			this.target_component = target_component;
		}
	 ...
	 */
	public static class MAV_MSG_SET_GPS_GLOBAL_ORIGIN extends Message {
		...
		public MAV_MSG_SET_GPS_GLOBAL_ORIGIN (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SET_GPS_GLOBAL_ORIGIN (short systemId, short componentId, int latitude  , int longitude  , int altitude  , int target_system  ) {
			super(systemId, componentId);
			this.latitude = latitude;
			this.longitude = longitude;
			this.altitude = altitude;
	 ...
	 */
	public static class MAV_MSG_RC_CHANNELS extends Message {
	 ...
	 */
	public static class MAV_MSG_NAV_CONTROLLER_OUTPUT extends Message {
		...
		public MAV_MSG_NAV_CONTROLLER_OUTPUT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_NAV_CONTROLLER_OUTPUT (short systemId, short componentId, float nav_roll  , float nav_pitch  , float alt_error  , float aspd_error  , float xtrack_error  , int nav_bearing  , int target_bearing  , int wp_dist  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_MISSION_CLEAR_ALL extends Message {
	
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_MISSION_CLEAR_ALL (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_CLEAR_ALL (short systemId, short componentId, int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.target_system = target_system;
			this.target_component = target_component;
		}
	 ...
	 */
	public static class MAV_MSG_PARAM_VALUE extends Message {
		...
		public MAV_MSG_PARAM_VALUE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_PARAM_VALUE (short systemId, short componentId, float param_value  , int param_count  , int param_index  , char param_id [] , int param_type  ) {
			super(systemId, componentId);
			this.param_value = param_value;
	 ...
	 */
	public static class MAV_MSG_TERRAIN_CHECK extends Message {
	
		private int lat; // Latitude (degrees *10^7)
		private int lon; // Longitude (degrees *10^7)
	
		public MAV_MSG_TERRAIN_CHECK (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_TERRAIN_CHECK (short systemId, short componentId, int lat  , int lon  ) {
			super(systemId, componentId);
			this.lat = lat;
			this.lon = lon;
		}
	 ...
	 */
	public static class MAV_MSG_RC_CHANNELS_SCALED extends Message {
		...
		public MAV_MSG_RC_CHANNELS_SCALED (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_RC_CHANNELS_SCALED (short systemId, short componentId, long time_boot_ms  , int chan1_scaled  , int chan2_scaled  , int chan3_scaled  , int chan4_scaled  , int chan5_scaled  , int chan6_scaled  , int chan7_scaled  , int chan8_scaled  , int port  , int rssi  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
	 ...
	 */
	public static class MAV_MSG_COMMAND_INT extends Message {
		...
		public MAV_MSG_COMMAND_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_COMMAND_INT (short systemId, short componentId, float param1  , float param2  , float param3  , float param4  , int x  , int y  , float z  , int command  , int target_system  , int target_component  , int frame  , int current  , int autocontinue  ) {
			super(systemId, componentId);
			this.param1 = param1;
			this.param2 = param2;
			this.param3 = param3;
	 ...
	 */
	public static class MAV_MSG_SAFETY_ALLOWED_AREA extends Message {
		...
		public MAV_MSG_SAFETY_ALLOWED_AREA (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SAFETY_ALLOWED_AREA (short systemId, short componentId, float p1x  , float p1y  , float p1z  , float p2x  , float p2y  , float p2z  , int frame  ) {
			super(systemId, componentId);
			this.p1x = p1x;
			this.p1y = p1y;
			this.p1z = p1z;
	 ...
	 */
	public static class MAV_MSG_SYS_STATUS extends Message {
		...
		public MAV_MSG_SYS_STATUS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SYS_STATUS (short systemId, short componentId, long onboard_control_sensors_present  , long onboard_control_sensors_enabled  , long onboard_control_sensors_health  , int load  , int voltage_battery  , int current_battery  , int drop_rate_comm  , int errors_comm  , int errors_count1  , int errors_count2  , int errors_count3  , int errors_count4  , int battery_remaining  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_RC_CHANNELS_OVERRIDE extends Message {
		...
		public MAV_MSG_RC_CHANNELS_OVERRIDE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_RC_CHANNELS_OVERRIDE (short systemId, short componentId, int chan1_raw  , int chan2_raw  , int chan3_raw  , int chan4_raw  , int chan5_raw  , int chan6_raw  , int chan7_raw  , int chan8_raw  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.chan1_raw = chan1_raw;
			this.chan2_raw = chan2_raw;
			this.chan3_raw = chan3_raw;
	 ...
	 */
	public static class MAV_MSG_GPS_STATUS extends Message {
		...
		public MAV_MSG_GPS_STATUS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS_STATUS (short systemId, short componentId, int satellites_visible  , int satellite_prn [] , int satellite_used [] , int satellite_elevation [] , int satellite_azimuth [] , int satellite_snr [] ) {
			super(systemId, componentId);
			this.satellites_visible = satellites_visible;
	 ...
	 * Battery information
	 */
	public static class MAV_MSG_BATTERY_STATUS extends Message {
		...
		public MAV_MSG_BATTERY_STATUS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_BATTERY_STATUS (short systemId, short componentId, int current_consumed  , int energy_consumed  , int temperature  , int voltages [] , int current_battery  , int id  , int battery_function  , int type  , int battery_remaining  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_GPS2_RAW extends Message {
		...
		public MAV_MSG_GPS2_RAW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_GPS2_RAW (short systemId, short componentId, long time_usec  , int lat  , int lon  , int alt  , long dgps_age  , int eph  , int epv  , int vel  , int cog  , int fix_type  , int satellites_visible  , int dgps_numch  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.lat = lat;
			this.lon = lon;
	...
	public static class MAV_MSG_DATA_STREAM extends Message {
		...
		public MAV_MSG_DATA_STREAM (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_DATA_STREAM (short systemId, short componentId, int message_rate  , int stream_id  , int on_off  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_MISSION_CURRENT extends Message {
	
		private int seq; // Sequence
	
		public MAV_MSG_MISSION_CURRENT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_CURRENT (short systemId, short componentId, int seq  ) {
			super(systemId, componentId);
			this.seq = seq;
		}
	 ...
	 */
	public static class MAV_MSG_SET_POSITION_TARGET_GLOBAL_INT extends Message {
		...
		public MAV_MSG_SET_POSITION_TARGET_GLOBAL_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SET_POSITION_TARGET_GLOBAL_INT (short systemId, short componentId, long time_boot_ms  , int lat_int  , int lon_int  , float alt  , float vx  , float vy  , float vz  , float afx  , float afy  , float afz  , float yaw  , float yaw_rate  , int type_mask  , int target_system  , int target_component  , int coordinate_frame  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
	 ...
	 */
	public static class MAV_MSG_MISSION_WRITE_PARTIAL_LIST extends Message {
		...
		public MAV_MSG_MISSION_WRITE_PARTIAL_LIST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_WRITE_PARTIAL_LIST (short systemId, short componentId, int start_index  , int end_index  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.start_index = start_index;
			this.end_index = end_index;
			this.target_system = target_system;
	 ...
	 */
	public static class MAV_MSG_HIL_RC_INPUTS_RAW extends Message {
		...
		public MAV_MSG_HIL_RC_INPUTS_RAW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_RC_INPUTS_RAW (short systemId, short componentId, long time_usec  , int chan1_raw  , int chan2_raw  , int chan3_raw  , int chan4_raw  , int chan5_raw  , int chan6_raw  , int chan7_raw  , int chan8_raw  , int chan9_raw  , int chan10_raw  , int chan11_raw  , int chan12_raw  , int rssi  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.chan1_raw = chan1_raw;
			this.chan2_raw = chan2_raw;
	 ...
	 */
	public static class MAV_MSG_HIL_OPTICAL_FLOW extends Message {
		...
		public MAV_MSG_HIL_OPTICAL_FLOW (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_OPTICAL_FLOW (short systemId, short componentId, long time_usec  , float flow_comp_m_x  , float flow_comp_m_y  , float ground_distance  , int flow_x  , int flow_y  , int sensor_id  , int quality  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.flow_comp_m_x = flow_comp_m_x;
			this.flow_comp_m_y = flow_comp_m_y;
	 ...
	 */
	public static class MAV_MSG_TERRAIN_REQUEST extends Message {
		...
		public MAV_MSG_TERRAIN_REQUEST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_TERRAIN_REQUEST (short systemId, short componentId, long mask  , int lat  , int lon  , int grid_spacing  ) {
			super(systemId, componentId);
			this.mask = mask;
			this.lat = lat;
			this.lon = lon;
	 ...
	 */
	public static class MAV_MSG_VFR_HUD extends Message {
		...
		public MAV_MSG_VFR_HUD (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_VFR_HUD (short systemId, short componentId, float airspeed  , float groundspeed  , float alt  , float climb  , int heading  , int throttle  ) {
			super(systemId, componentId);
	 ...
	 */
	public static class MAV_MSG_MISSION_REQUEST extends Message {
	
		private int seq; // Sequence
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_MISSION_REQUEST (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_REQUEST (short systemId, short componentId, int seq  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.seq = seq;
			this.target_system = target_system;
			this.target_component = target_component;
	 ...
	 * Power supply status
	 */
	public static class MAV_MSG_POWER_STATUS extends Message {
		...
		public MAV_MSG_POWER_STATUS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_POWER_STATUS (short systemId, short componentId, int Vcc  , int Vservo  , int flags  ) {
			super(systemId, componentId);
			this.Vcc = Vcc;
			this.Vservo = Vservo;
			this.flags = flags;
	 ...
	 * Set vehicle position, velocity and acceleration setpoint in local frame.
	 */
	public static class MAV_MSG_SET_POSITION_TARGET_LOCAL_NED extends Message {
		...
		public MAV_MSG_SET_POSITION_TARGET_LOCAL_NED (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SET_POSITION_TARGET_LOCAL_NED (short systemId, short componentId, long time_boot_ms  , float x  , float y  , float z  , float vx  , float vy  , float vz  , float afx  , float afy  , float afz  , float yaw  , float yaw_rate  , int type_mask  , int target_system  , int target_component  , int coordinate_frame  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.x = x;
			this.y = y;
	 ...
	 */
	public static class MAV_MSG_PARAM_REQUEST_READ extends Message {
		...
		public MAV_MSG_PARAM_REQUEST_READ (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_PARAM_REQUEST_READ (short systemId, short componentId, int param_index  , int target_system  , int target_component  , char param_id [] ) {
			super(systemId, componentId);
			this.param_index = param_index;
			this.target_system = target_system;
			this.target_component = target_component;
	 ...
	 */
	public static class MAV_MSG_MISSION_COUNT extends Message {
	
		private int count; // Number of mission items in the sequence
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_MISSION_COUNT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_COUNT (short systemId, short componentId, int count  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.count = count;
			this.target_system = target_system;
			this.target_component = target_component;
	 ...
	 */
	public static class MAV_MSG_HIL_STATE_QUATERNION extends Message {
		...
		public MAV_MSG_HIL_STATE_QUATERNION (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_STATE_QUATERNION (short systemId, short componentId, long time_usec  , float attitude_quaternion [] , float rollspeed  , float pitchspeed  , float yawspeed  , int lat  , int lon  , int alt  , int vx  , int vy  , int vz  , int ind_airspeed  , int true_airspeed  , int xacc  , int yacc  , int zacc  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
	 ...
	 * Set vehicle position, velocity and acceleration setpoint in the WGS84 coordinate system.
	 */
	public static class MAV_MSG_POSITION_TARGET_GLOBAL_INT extends Message {
		...
		public MAV_MSG_POSITION_TARGET_GLOBAL_INT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_POSITION_TARGET_GLOBAL_INT (short systemId, short componentId, long time_boot_ms  , int lat_int  , int lon_int  , float alt  , float vx  , float vy  , float vz  , float afx  , float afy  , float afz  , float yaw  , float yaw_rate  , int type_mask  , int coordinate_frame  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.lat_int = lat_int;
			this.lon_int = lon_int;
	 ...
	 */
	public static class MAV_MSG_MISSION_SET_CURRENT extends Message {
	
		private int seq; // Sequence
		private int target_system; // System ID
		private int target_component; // Component ID
	
		public MAV_MSG_MISSION_SET_CURRENT (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MISSION_SET_CURRENT (short systemId, short componentId, int seq  , int target_system  , int target_component  ) {
			super(systemId, componentId);
			this.seq = seq;
			this.target_system = target_system;
			this.target_component = target_component;
	 ...
	 */
	public static class MAV_MSG_MANUAL_CONTROL extends Message {
		...
		public MAV_MSG_MANUAL_CONTROL (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_MANUAL_CONTROL (short systemId, short componentId, int x  , int y  , int z  , int r  , int buttons  , int target  ) {
			super(systemId, componentId);
			this.x = x;
			this.y = y;
			this.z = z;
	 ...
	 */
	public static class MAV_MSG_SCALED_PRESSURE extends Message {
		...
		public MAV_MSG_SCALED_PRESSURE (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_SCALED_PRESSURE (short systemId, short componentId, long time_boot_ms  , float press_abs  , float press_diff  , int temperature  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.press_abs = press_abs;
	 ...
	 * The global position, as returned by the Global Positioning System (GPS). This is
                 NOT the global position estimate of the sytem, but rather a RAW sensor value. See message GLOBAL_POSITION for the global position estimate. Coordinate frame is right-handed, Z-axis up (GPS frame).
	 */
	public static class MAV_MSG_HIL_GPS extends Message {
		...
		public MAV_MSG_HIL_GPS (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIL_GPS (short systemId, short componentId, long time_usec  , int lat  , int lon  , int alt  , int eph  , int epv  , int vel  , int vn  , int ve  , int vd  , int cog  , int fix_type  , int satellites_visible  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.lat = lat;
			this.lon = lon;
	 ...
	 * Set the vehicle attitude and body angular rates.
	 */
	public static class MAV_MSG_ATTITUDE_TARGET extends Message {
		...
		public MAV_MSG_ATTITUDE_TARGET (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_ATTITUDE_TARGET (short systemId, short componentId, long time_boot_ms  , float q [] , float body_roll_rate  , float body_pitch_rate  , float body_yaw_rate  , float thrust  , int type_mask  ) {
			super(systemId, componentId);
			this.time_boot_ms = time_boot_ms;
			this.q = q;
			this.body_roll_rate = body_roll_rate;
	 ...
	 * The IMU readings in SI units in NED body frame
	 */
	public static class MAV_MSG_HIGHRES_IMU extends Message {
		...
		public MAV_MSG_HIGHRES_IMU (byte[] bytes) {
			super(bytes);
		}
	
		public MAV_MSG_HIGHRES_IMU (short systemId, short componentId, long time_usec  , float xacc  , float yacc  , float zacc  , float xgyro  , float ygyro  , float zgyro  , float xmag  , float ymag  , float zmag  , float abs_pressure  , float diff_pressure  , float pressure_alt  , float temperature  , int fields_updated  ) {
			super(systemId, componentId);
			this.time_usec = time_usec;
			this.xacc = xacc;
			this.yacc = yacc;
